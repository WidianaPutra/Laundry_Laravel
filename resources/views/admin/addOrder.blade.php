<x-layout :title="'Atelier Laundry'" :navbar="'hide'">
    <div class="flex items-center justify-center min-h-screen">
        <div class="w-full max-w-md bg-white rounded-2xl shadow-xl p-8">
            <form class="">
                <label class="block mb-2 font-medium text-gray-700">Nama User</label>
                <input type="text" name="nama_user"
                    class="w-full p-2 border-2 rounded-lg focus:ring focus:ring-blue-300"
                ...
                <select name="paket" class="w-full p-2 border-2 rounded-lg focus:ring focus:ring-blue-300">
